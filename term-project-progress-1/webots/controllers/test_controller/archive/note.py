...
if __name__ == "__main__":
    Quadcopter = Quadcopter() # Create robot

    Quadcopter.createTrajectory() # Create Trajectory for robot

    timestep = int(Quadcopter.robot.getBasicTimeStep())

    while Quadcopter.robot.step(timestep) != -1: # Run the script
        Quadcopter.run()
